...
AMI_IMAGE="ami-079db87dc4c10ac91"
...
SECURITY_GROUP_ID=$(aws ec2 create-security-group \
    --group-name 'ray-sg' \
    --description 'Security group for the Ray (not) financial advisor.' \
    --tag-specifications 'ResourceType=security-group,Tags=[{Key=Name,Value=ray-sg}]' \
